...
| Tier | Investment Size | Decision Authority | Cycle Time Target | Value Rigor |
|------|----------------|-------------------|------------------|-------------|
| **Enhancement** | <$50k | Product Team Lead + DAR | 3 days | Lightweight value assessment |
| **Tier 3** | $50k-$500k | EPMO/EA + Tech Subcommittee | 7-12 days | Standard business case with ROI |
| **Tier 2** | $500k-$2M | EA + Tech Subcommittee + TAC | 14 days | Formal business case + architecture |
| **Tier 1** | >$2M | EA + Executive Sponsors + TAC | 14+ days | Comprehensive business case + multi-year plan |
...
7. [Process Flows and Decision Gates](#7-process-flows-and-decision-gates)
8. [Roles and Responsibilities](#8-roles-and-responsibilities)
9. [Value Governance and Oversight](#9-value-governance-and-oversight)
...
### 1.3 Investment Tier Definitions and Value Thresholds

#### Enhancement Tier (<$50k)
**Characteristics:**
- Small, incremental improvements to existing systems or processes
- Low complexity, contained within single domain
...
- May involve multiple systems or business processes
...
- Cross-domain integration and process changes
...
- Enterprise-wide impact across multiple domains
...
```mermaid
flowchart TD
    A[Team Member Submits Enhancement Request] --> B{Complete Enhancement<br/>Value Assessment?}
    B -->|No| C[Return to Requester<br/>for Completion]
    B -->|Yes| D{DAR Review<br/>Required?}
    D -->|No| E[Product Team Lead<br/>Reviews Value & Budget]
    D -->|Yes| F[DAR Technical<br/>Screening]
    F --> G{DAR Decision}
    G -->|Approved| E
    G -->|Escalate to EA| H[EA Review<br/>Complex Enhancement]
    G -->|Rejected| I[Enhancement Rejected<br/>Feedback Provided]
    E --> J{Product Lead<br/>Decision}
    J -->|Approved| K[Add to Team Backlog<br/>or Kanban]
    J -->|Rejected| I
    H --> L{EA Decision}
    L -->|Approved| E
    L -->|Rejected or<br/>Re-scope| I
    K --> M[Implementation]
    M --> N[Value Realization<br/>Tracking - Sample Basis]

    style D fill:#ffe4cc,stroke:#ff8800
    style G fill:#ffe4cc,stroke:#ff8800
    style J fill:#ffe4cc,stroke:#ff8800
...
### 3.1 Tier 3 Value Evaluation ($50k-$500k)
...
### 3.2 Tier 2 Value Evaluation ($500k-$2M)
...
### 3.3 Tier 1 Value Evaluation (>$2M)
...
- [ ] Less than $50k → Enhancement Form
- [ ] $50k - $500k → Tier 3 Project Form
- [ ] $500k - $2M → Tier 2 Project Form
- [ ] Greater than $2M → Tier 1 Program Form
- [ ] Unknown → Default to Tier 3 form; will be re-tiered during screening

**Question 3: Requester Information**
- Name:
- Title:
...
#### 4.3.2 Tier 3 Project Intake Form

**Format:** 2-3 page web form (15-20 minutes to complete)
...
- What problem or opportunity does this address? [Paragraph]
- What are the consequences of NOT doing this project? [Paragraph]
- Who are the primary beneficiaries? [Checkboxes: Customers, Operations, Regulatory, Internal Teams, etc.]

**Section 3: Proposed Solution**
- Solution Description: [2-3 paragraphs]
- Key Deliverables: [Bullet list]
- Systems/Platforms Involved: [Checkboxes or multi-select]
- Estimated Timeline: [Start date, end date]
- Critical Dependencies: [List]

**Section 4: Expected Value**
For each value category, provide estimate:
- **Operational Value:** [Quantified impact]
- **Financial Value:** [$ savings or cost avoidance]
- **Customer Value:** [Metrics: NPS, satisfaction, etc.]
- **Regulatory/Compliance Value:** [Compliance achieved, risk reduced]
- **Strategic/Capability Value:** [Capabilities enabled]

**Section 5: Cost Estimate**
- Capital Expenditure: $___k
- Operating Expenditure (Year 1): $___k
- Estimated Total 5-Year TCO: $___k
- Funding Source: [Regulated CAPEX, Non-Regulated OPEX, Grant, etc.]
...
[Upload: rough estimates, requirements, vendor quotes, diagrams, etc.]

**Submit Button:** Creates Tier 3 demand record; auto-routes to EPMO + EA for screening

---

#### 4.3.3 Tier 2 Project Intake Form

**Format:** Similar to Tier 3 with additional depth

**Additional Sections Beyond Tier 3:**

**Section 8: Organizational Impact**
- Departments/Functions Impacted: [List]
- Process Changes Required: [Description]
- Change Management Needs: [Training, communication, stakeholder engagement]

**Section 9: Architectural Considerations**
- Does this integrate with 3+ systems? Y/N
- Does this involve new technology or vendors? Y/N
- Does this create new enterprise capability? Y/N
- Architectural complexity self-assessment: [Low / Medium / High]

**Section 10: Strategic Context**
- How does this enable our strategy? [Detailed explanation]
- What is the competitive/market driver? [If applicable]
- Is this a regulatory mandate or strategic choice? [Select]

**Submit Button:** Creates Tier 2 demand record; auto-routes to EPMO + EA + Strategic Planning for pre-screening
...
- **Tier Selection Guide:** Decision tree to help determine correct tier
...
- **Video Tutorials:** Short videos walking through intake process
- **Templates and Tools:** Excel templates for cost/benefit estimation
...
| **Tier Appropriate** | Clearly <$50k | Borderline (could be Tier 3) | Obviously >$50k (re-tier) |
...
| **Tier Appropriate** | $50k-$500k range | Borderline (could be Enhancement or Tier 2) | Wrong tier (re-tier) |
...
| **Duplica te Check** | Not duplicate | Similar to existing but distinct | Duplicate (consolidate) |
...
| **Architectural Complexity** | Complexity understood and manageable | Complexity acknowledged; needs further analysis | Underestimated complexity (likely to fail) |
...
| **Tier Appropriate** | $500k-$2M range | Borderline | Wrong tier |
...
#### 5.3.2 Tier 3 Qualification

**Qualification Owner:** Business Sponsor (with support from PMO and EA/DAR)

**Activities:**
1. **Develop Business Case:** Use Tier 3 template; quantify value; create financial model
2. **Architecture Review:** EA/DAR reviews technical approach (may be concurrent with business case)
3. **Stakeholder Validation:** Confirm sponsor support, resource availability
4. **Quality Check:** PMO reviews business case for completeness and quality

**Time:** 5-7 days (standard); up to 10 days (complex)

**Support Available:**
- PMO business analyst can assist with financial modeling
- EA/DAR provides architectural guidance
- Finance provides cost validation

**Output:** Qualified Tier 3 Business Case ready for Technology Subcommittee

**Quality Gate:** PMO validates business case meets quality standard before advancing to governance

---

#### 5.3.3 Tier 2 Qualification

**Qualification Owner:** Business Sponsor + Project Manager (assigned early)

**Activities:**
1. **Assemble Project Team:** Sponsor, PM, key SMEs, EA, Finance
2. **Develop Formal Business Case:** 15-20 page document per template
3. **Detailed Value Quantification:** Work with Finance to build detailed financial model
4. **Architecture Review:** EA performs formal architecture assessment
5. **Organizational Impact Analysis:** Assess change management, training, process impacts
6. **Risk Assessment:** Develop comprehensive risk register
7. **Stakeholder Engagement:** Validate with affected stakeholders; build coalition
8. **Quality Review:** PMO + Finance + EA review for quality and completeness

**Time:** 10-14 days

**Support Available:**
- PMO assigns dedicated business analyst
- Finance assigns FP&A analyst for financial modeling
- EA assigns architect for architecture review
- Change management resource if needed

**Output:** Formal Tier 2 Business Case + Architecture Review Report

**Quality Gate:** Multi-party review (PMO, Finance, EA) before advancing to governance
...
## 7. Process Flows and Decision Gates

### 7.1 End-to-End Process Flow (All Tiers)
...
flowchart TD
    ...
    Qualify --> ArchReview{Architecture Review<br/>EA or DAR}
    ArchReview -->|Approved| Governance[Governance Review<br/>Tech Sub or TAC]
    ArchReview -->|Conditional| Qualify
    ArchReview -->|Rejected| End1

    Governance -->|Recommend Approve| FinalDecision{Final Decision<br/>TAC or Product Lead}
    Governance -->|Recommend Defer| End2[Deferred - Revisit Later]
    Governance -->|Recommend Reject| End1

    FinalDecision -->|Approved| Execute[Project/Enhancement Execution]
    FinalDecision -->|Deferred| End2
    FinalDecision -->|Rejected| End1

    Execute --> ValueTrack[Value Realization Tracking]
    ValueTrack --> Lessons[Lessons Learned & Continuous Improvement]
    Lessons --> End3[Closed - Value Realized]

    style Screen fill:#ffe4cc,stroke:#ff8800
    style ArchReview fill:#f3e5f5,stroke:#7b1fa2
    style Governance fill:#cde4ff,stroke:#0050be
    style FinalDecision fill:#ffe4cc,stroke:#ff8800
```
...
```mermaid
flowchart LR
    A[Team Member<br/>Submits Enhancement] --> B[Gate 1:<br/>Completeness Check<br/>Auto + Team Lead]
    B -->|Pass| C[Gate 2:<br/>DAR Technical Review<br/>If Triggered]
    B -->|Fail| Z1[Return for Completion]
    C -->|Approved| D[Gate 3:<br/>Team Lead Decision<br/>Value + Budget]
    C -->|Escalate| E[EA Review]
    C -->|Not Required| D
    E -->|Approved| D
    E -->|Rejected| Z2[Rejected]
    D -->|Approved| F[Added to Backlog]
    D -->|Rejected| Z2
    F --> G[Implementation]
    G --> H[Value Tracking<br/>Sample Basis]

    style B fill:#ffe4cc,stroke:#ff8800
...
flowchart LR
    ...
    C --> D[Gate 2:<br/>Architecture Review<br/>EA or DAR]
    D -->|Approved| E[Gate 3:<br/>Tech Subcommittee<br/>Review & Recommend]
    D -->|Conditional| C
    D -->|Rejected| Z1
    E -->|Recommend| F[Gate 4:<br/>TAC Funding<br/>Decision]
    E -->|Reject| Z1
    F -->|Approved| G[Project Charter<br/>& Execution]
    F -->|Deferred| Z2[Deferred]
    F -->|Rejected| Z1
    G --> H[Quarterly Value<br/>Tracking x 4]

    style B fill:#ffe4cc,stroke:#ff8800
    style D fill:#f3e5f5,stroke:#7b1fa2
    style E fill:#cde4ff,stroke:#0050be
    style F fill:#ffe4cc,stroke:#ff8800
```
...
flowchart LR
    ...
    B -->|Table| Z2[Tabled]
    B -->|Reject| Z1[Rejected]
    C --> D[Gate 2:<br/>Architecture Board<br/>EA Team Review]
    D -->|Approved| E[Gate 3:<br/>Tech Subcommittee<br/>Deep Dive]
    D -->|Conditional| C
    D -->|Rejected| Z1
    E -->|Recommend| F[Gate 4:<br/>TAC Review &<br/>Funding Decision]
    E -->|Reject| Z1
    F -->|Approved| G[Project Charter<br/>& Execution]
    F -->|Deferred| Z2
    F -->|Rejected| Z1
    G --> H[Monthly Value Tracking<br/>x6, then Quarterly x6]
...
```mermaid
flowchart LR
    A[Submit Program<br/>Brief] --> B[Gate 0:<br/>Strategic Alignment<br/>Sponsor + Strategy + CIO]
    B -->|Proceed| C[Qualification:<br/>Comprehensive<br/>Program Charter 4-8wks]
    B -->|Table| Z2[Tabled]
    B -->|Reject| Z1[Rejected]
    C --> D[Gate 1:<br/>Architecture Board<br/>Future State Review]
    D -->|Approved| E[Gate 2:<br/>Tech Subcommittee<br/>Deep Dive Session]
    D -->|Conditional| C
    D -->|Rejected| Z1
    E -->|Recommend| F[Gate 3:<br/>ELT Pre-Briefing<br/>Alignment Session]
    E -->|Reject| Z1
    F --> G[Gate 4:<br/>TAC Review &<br/>Authorization]
    G -->|Approved| H{Requires<br/>Board?}
    G -->|Conditional| C
    G -->|Deferred| Z2
    G -->|Rejected| Z1
    H -->|Yes >$10M| I[Gate 5:<br/>Board Approval]
    H -->|No| J[Program Execution]
    I -->|Approved| J
    I -->|Deferred| Z2
    J --> K[Quarterly Value Tracking<br/>Multi-Year + TAC Reviews]

    style B fill:#ffe4cc,stroke:#ff8800
    style D fill:#f3e5f5,stroke:#7b1fa2
    style E fill:#cde4ff,stroke:#0050be
    style F fill:#cde4ff,stroke:#0050be
    style G fill:#ffe4cc,stroke:#ff8800
    style I fill:#ffe4cc,stroke:#ff8800
```
...
| Activity | Sponsor | PM | DAR | EA | EPMO | Finance | Tech Sub | TAC |
|----------|---------|----|----|----| ------|---------|----------|-----|
| Submit Intake | R/A | C | | | I | | | |
| Screening | I | | R | C | R/A | | | |
| Business Case Development | A | R | C | C | C | C | | |
| Architecture Review (standard) | I | C | R/A | C | I | | | |
| Architecture Review (escalated) | I | C | C | R/A | I | | | |
| Quality Check (Business Case) | I | C | | | R/A | C | | |
| Tech Subcommittee Review | R | R | | C | C | I | R/A | |
| TAC Funding Decision | I | I | | | I | I | I | R/A |
| Project Execution | A | R | C | C | C | C | I | I |
| Value Realization Tracking | A | R | | | C | C | I | I |

---

#### 8.1.3 Tier 2 Project Responsibilities

| Activity | Sponsor | PM | EA | EPMO | Finance | Strategy | Tech Sub | TAC |
|----------|---------|----|----|------|---------|----------|----------|-----|
| Submit Intake | R/A | C | | I | | | | |
| Pre-Screening | I | | R | C | | R/A | | |
| Business Case Development | A | R | C | C | R | C | | |
| Architecture Board Review | I | C | R/A | C | C | | | |
| Quality Check | I | C | C | R/A | R | | | |
| Tech Subcommittee Deep Dive | R | R | R | C | C | C | R/A | |
| TAC Funding Decision | R | C | C | I | I | | I | R/A |
| Project Execution | A | R | C | C | C | | I | I |
| Value Realization Tracking | A | R | | C | R | | I | I |
...
- **Accountable for:** Demand intake process; screening quality; portfolio reporting; methodology
- **Responsibilities:**
  - Manage intake portal and demand records (ServiceNow)
  - Conduct screening for completeness and tier appropriateness
  - Assign project managers to approved demands
  - Provide business case development support and templates
  - Facilitate value realization tracking
  - Produce portfolio reports for governance
  - Maintain demand management process and continuous improvement
- **Staffing:** PMO Director + Business Analysts + Project Coordinators
- **Service Model:** Centralized PMO supporting all tiers
...
- **Accountable for:** Architectural integrity; technology strategy; enterprise standards
- **Responsibilities:**
  - Develop and maintain architectural standards and patterns
  - Mandatory review of all Tier 1 and Tier 2 demands
  - Review escalated Tier 3 and complex Enhancements
  - Provide architectural consultation to DARs and project teams
  - Present architecture recommendations to Tech Sub and TAC
  - Conduct quality audits of DAR decisions
  - Lead strategic architecture initiatives
- **Decision Authority:**
  - Approve/reject architecture for Tier 1/2
  - Veto any demand that violates enterprise architecture standards
  - Grant exceptions to standards (with documentation)
- **Time Commitment:** With federated model, target <10% time on Enhancement/standard Tier 3; >50% on strategic work

**Domain Architecture Reviewer (DAR)**
- **Accountable for:** Architectural review of Enhancements and standard Tier 3 in assigned domain
- **Responsibilities:**
  - Screen all Enhancement and Tier 3 demands in domain for architectural implications
  ...
  - Participate in Federated Architecture Council
  - Contribute to evolution of architectural standards
- **Decision Authority:**
  - Approve/reject Enhancements independently
  - Approve standard Tier 3 following established patterns
  - Escalate to EA when complexity triggers present
- **Selection Criteria:** 10+ years technical experience; deep domain knowledge; architectural aptitude; peer respect
- **Time Commitment:** 20-30% of role (formalized in performance objectives)
...
```mermaid
graph TD
    Board[Board of Directors<br/>Quarterly] -->|Oversight & Largest Approvals| TAC
    TAC[Technology Advisory Committee TAC<br/>Monthly<br/>CIO, CFO, Executives] -->|Funding Decisions| Portfolio[Investment Portfolio]
    TAC -->|Strategy & Policy| TechSub
    TechSub[Technology Subcommittee<br/>Bi-Weekly<br/>IT Directors, EA, PMO, Business] -->|Recommendations| TAC
    TechSub -->|Review & Prioritize| Demands[Tier 3, 2, 1 Demands]
    ...
    Finance[Finance / FP&A] -->|Financial Validation| Demands
    Finance -->|Budget & Funding| TAC

    Strategy[Strategic Planning] -->|Strategic Alignment| Demands
    Strategy -->|Strategic Portfolio View| TAC

    style Board fill:#e8f5e9,stroke:#2e7d32
    style TAC fill:#ffe4cc,stroke:#ff8800
    style TechSub fill:#cde4ff,stroke:#0050be
    style EA fill:#f3e5f5,stroke:#7b1fa2
    style DAR fill:#f3e5f5,stroke:#7b1fa2
```
